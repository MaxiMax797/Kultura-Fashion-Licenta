...
exports.create  = async (req, res) => {
    try{
        ...
        console.log(error)
        return res.status(500).json({message: 'Error while trying to create a review!'})
    }
}
...
exports.getByProductId = async (req, res) => {
    try{
        ...
        console.log(error)
        res.status(500).json({message: 'Error while trying to fetch reviews!'})
    }
}
...
exports.updateById = async (req, res) => {
    ...
    {
        console.log(error)
        res.status(500).json({message: 'Error while trying to update review!'})
    }
}
...
exports.deleteById = async (req, res) => {
    ...
    try{
        ...
        console.log(error)
        res.status(500).json({message: 'Error while trying to delete review!'})
    }
}