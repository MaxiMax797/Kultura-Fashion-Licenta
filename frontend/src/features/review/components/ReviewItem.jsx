    ...
    <Stack position={'relative'} p={2} rowGap={2} width={'100%'} component={Paper} borderRadius={'.8px'}>
        ...
        <Stack flexDirection={'row'} justifyContent={'space-between'} alignItems={'center'}>
            ...
            isOwnReview && (
                ...
                <MenuItem onClick={()=>{setEdit(true);handleClose()}}>Modifica</MenuItem>
                <MenuItem onClick={deleteReview}>Sterge</MenuItem>
                </Menu>
            </Stack>
            )
            }
        ...
        <Stack>
            ...
            edit?(
                ...
                <Stack flexDirection={'row'} alignSelf={'flex-end'} columnGap={1} justifyContent={'center'} alignItems={'center'}>
                    ...
                    <Button variant='outlined' size='small' onClick={()=>setEdit(false)} color='error'>Anuleaza</Button>
                </Stack>
                </Stack>
